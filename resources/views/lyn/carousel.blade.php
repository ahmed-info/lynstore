        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto text-center">
                    ...
                    <p class="text-white my-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorem rem eveniet molestiae ipsum. Explicabo ipsum dignissimos nemo quo. Provident, rem laboriosam dolorem dolorum animi dolores a eos totam quaerat impedit!</p>
                    <a href="#" class="btn me-3 btn-primary">Get Started</a>
                    <a href="#" class="btn btn-outline-light">My Protfolio</a>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row mb-5">
                <div class="col-md-8 mx-auto text-center">
                    ...
                    <h1>Our Services</h1>
                    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, ducimus. Et repellat, modi id aperiam, architecto suscipit nesciunt nisi quod corrupti eum sit, ipsam obcaecati iusto? Earum cum dicta fugit.</p>
                </div>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-sm-6">
                    <div class="service card-effect">
                        ...
                        <p>
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Beatae vitae qui quisquam nulla voluptate molestiae, odio rerum! Asperiores, quidem iure.
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-10 offset-md-1">
                        ...
                        <h1>Best solution for you businnes</h1>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis, ducimus. Et repellat, modi id aperiam, architecto suscipit nesciunt nisi quod corrupti eum sit, ipsam obcaecati iusto? Earum cum dicta fugit.</p>
                ...
                <div class="row text-center">
                    <div class="col-lg-3 col-sm-6">
                        <div class="team-member card-effect">
                            <img src="../../images/cover2.png" alt="" srcset="">
                            <h5 class="mb-0 mt-4">Ahmed Razzaq</h5>
                            <p>Web DEVELOPER</p>
        ...
        <section id="contact">
            <div class="container">
                ...
                <form action="" class="row g-3 justify-content-center">
                    ...
                    <div class="col-md-10">
                        <textarea name="" id="" cols="30" rows="5" type="text" class="form-control" placeholder="Enter Message"></textarea>
                    </div>
        ...
        <footer>
            <div class="footer-top">
                <div class="container">
                    <div class="row gy-4">
                        <div class="col-md-4">
                            <img class="logo" src="../../images/logolyn.png" alt="">
                        </div>
                        <div class="col-md-2">
